...
class _SignupPageState extends State<SignupPage> {
      ...
      body: BlocConsumer<SignupBloc, SignupState>(
        listener: (context, state) {
          if (state is SignupError) {
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => OtpVerificationPage(phoneNumber: '${_countryCode}${_phone.text.trim()}',)));
          }
        },
        ...
        GestureDetector(
          ...
          child: CircleAvatar(
            ...
            child: _profileImage == null
                ? Icon(Icons.camera_alt, size: 40.r, color: AppColors.textPrimary)
                : null,
          ),
        ),
  ...
  Widget _buildSignupForm() {
    return Container(
      ...
      child: Column(
        children: [
          Text('Create Account', style: AppTextStyles.headline2.copyWith(color: Colors.white)),
          SizedBox(height: 20.h),
  ...
  Widget _buildNameFields(GlobalKey<FormFieldState> firstnamekey, GlobalKey<FormFieldState> lastNamekey) {
    return Row(
      children: [
        Expanded(
          child: TextFormField(
...
FlutterSecureData.deleteWholeSecureData().then((value){
  ...
  FlutterSecureData.setUserData(jsonEncode(userData));
    ...
    final doneTasks = [
  {
    'employeeName': '${userData['firstName']??'name'} ${userData['lastName']??''}',
  ...
  },
  {
    ...
    'taskDescription': 'Discuss strategy for upcoming project and milestones',
  ...
  },
  {
    ...
    'taskDescription': 'Call client to discuss project updates and deadlines',
    'location': 'Remote',
  ...
  },
  {
    ...
    'taskDescription': 'Discuss progress on internal project and team performance',
  ...
  },
  {
    ...
    'taskDescription': 'Prepare slides and materials for the upcoming workshop',
  ...
  },
  {
    ...
    'taskDescription': 'Review project progress and set next steps with team',
