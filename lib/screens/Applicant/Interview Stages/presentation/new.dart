...
//         final userJson = (decoded['data'] as List).first;
...
//     // final candidateStageData = await ApiService(Dio()).getCandiateStage();
...
//                     job, stages, currentStep, media, userData),
//               ],
//             ),
//           );
//         },
...
//   Widget buildJobAndStagesCard(Job job, List<InterviewStage> stages,
//       int currentStep, Size media, UserData? user) {
//     return Card(
//       elevation: 6,
...
//                   Text("📃 Type: ${user == null ? "" : user.jobDescription}"),
